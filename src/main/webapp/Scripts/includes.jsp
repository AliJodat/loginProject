...
<link rel="stylesheet" href="<c:url value='/Scripts/LoginScripts/custom.css'/>" />


<script src="<c:url value='/Scripts/jquery/jquery-3.3.1.js'/>"></script>
...
<link rel="stylesheet" href="<c:url value='/Scripts/jquery-tmpl/jquery.tmpl.js'/>"/>
